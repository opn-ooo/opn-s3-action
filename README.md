  ...
  deploy:
    ...
    - uses: opn-ooo/opn-s3-action@master
      ...
      env:
        ...
        AWS_REGION: 'apt-southeast-1'   # optional: defaults to ap-southeast-1
...
| `AWS_REGION` | The region where you created your bucket. Set to `ap-southeast-1` by default. [Full list of regions here.](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions) | `env` | No | `ap-southeast-1` |
